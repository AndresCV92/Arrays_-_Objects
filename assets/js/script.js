const propiedades_ventas = [
  ...
  },
  {
    ...
    src: 'https://tse2.mm.bing.net/th?id=OIP.SvJJKziyLVT3VY8_CTG2vwHaFZ&pid=Api&P=0&h=180',
...
const propiedades_alquiler = [
  ...
  },
  {
    ...
    src: 'https://tse3.mm.bing.net/th?id=OIP.jS558Iaoqp0b5lqVsdHYWgHaEo&pid=Api&P=0&h=180',
...
//HTML de las propiedades en venta
function generarHTMLVentas() {
  let htmlVentas = "";
  propiedades_ventas.forEach((en_venta) => {
    ...
    let permitirMascotas = en_venta.pets ? '<i class="fas fa-paw"></i> Mascotas permitidas' : '<i class="fas fa-ban"></i> No se permiten mascotas';
...
// HTML de las propiedades en alquiler
function generarHTMLAlquiler() {
  let htmlAlquiler = "";
  propiedades_alquiler.forEach((en_alquiler) => {
    ...
    let permitirMascotas = en_alquiler.pets ? '<i class="fas fa-paw"></i> Mascotas permitidas' : '<i class="fas fa-ban"></i> No se permiten mascotas';
...
function inicializarPaginaVentas() {
  const contenedorVentas = document.getElementById("propiedades-ventas");
  if (contenedorVentas) {
    contenedorVentas.innerHTML = generarHTMLVentas();
  }
}


function inicializarPaginaAlquiler() {
  const contenedorAlquiler = document.getElementById("propiedades-alquiler");
  if (contenedorAlquiler) {
    contenedorAlquiler.innerHTML = generarHTMLAlquiler();
  }
}
